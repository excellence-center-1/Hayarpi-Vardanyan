...
rectangle.width = -2;
rectangle.height = 0;
console.log('Area:', rectangle.getArea > 0 ? rectangle.getArea : 'Invalid dimensions. Cannot calculate area.');
console.log('Perimeter:', rectangle.getPerimeter > 0 ? rectangle.getPerimeter: 'Invalid dimensions. Cannot calculate perimeter.');
